	...
	do
		...
		do
			...
			then
				...
				echo "python step5_test_statistics_analysis_45degree.py --hic_name ${hic} --pairwise_resolution ${pairwise_resolution} --random_seed ${seed}" >> run_${hic}_${pairwise_resolution}_${seed}.slurm
