...
do
	...
	do
		...
		do
			for seq in wt mt
			do
				#python danq_gcn_inference_gpu.py --our_model_name ${hic}_dnabert_replicate${replicate}.pkl --our_model_path ../model_assessment/concatenation_model/deepsea_bce_gcn_100000/ --sota_model_name DanQ_replicated.pkl --sota_model_path ../model_assessment/sota_model/ --seq_input_path GTEx_processed/ --seq_input_name GTEx_${cellline}_${seq}_seq.npy --structure_input_matching_name GTEx_${cellline}_structure_matching.npy --structure_input_path ../graph_data/if_matrix_100000/${hic}_novc_whole_normalized.npy --structure_input_matching_path GTEx_processed/ --feature_selected_boolean_path ../3dstructure_sanitycheck_data/deepsea_data/${cellline}_feature_index.npy --experiment_name GTEx_${cellline}_gcn --output_path model_prediction/ --output_our_model_name replicate${replicate} --output_sota_name sota --seq_specific_name ${seq} --node_feature_type dnabert
				python danq_gcn_inference_gpu.py --our_model_name ${hic}_dnabert_replicate${replicate}.pkl --our_model_path  --sota_model_name DanQ_replicated.pkl --sota_model_path ../model_assessment/sota_model/ --seq_input_path GTEx_processed/ --seq_input_name GTEx_${cellline}_${seq}_seq.npy --structure_input_matching_name GTEx_${cellline}_structure_matching.npy --structure_input_path ../graph_data/if_matrix_100000/${hic}_novc_whole_normalized.npy --structure_input_matching_path GTEx_processed/ --feature_selected_boolean_path ../3dstructure_sanitycheck_data/deepsea_data/${cellline}_feature_index.npy --experiment_name GTEx_${cellline}_gcn --output_path model_prediction/ --output_our_model_name replicate${replicate} --output_sota_name sota --seq_specific_name ${seq} --node_feature_type dnabert
			done
			python get_log_odds_fc.py --input_path model_prediction/ --experiment_name GTEx_${cellline}_gcn_replicate${replicate} --output_path model_prediction/
		done
		python get_log_odds_fc.py --input_path model_prediction/ --experiment_name GTEx_${cellline}_gcn_sota --output_path model_prediction/
	done
	...
	do
		...
		do
			...
			do
				for seq in wt mt
				do
					if test ! -f model_prediction/GRASP_${label}_${fold}_${hic}_gcn_dnabert_replicate${replicate}_${seq}_prediction.npy
					then
