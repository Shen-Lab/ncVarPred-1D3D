...
do
	...
	echo "python danq_diff_pathogenic_test.py --model_input_path ../trained_model/fewshot_pathogenic_model/CNN_RNN_related_pathogenic/DanQ_diff_pathogenic_fewshotsize${fewshotsize}.pkl --result_output_path model_prediction/DanQ_diff_pathogenic_fewshotsize${fewshotsize}_auroc_auprc.npy" >> run.slurm
	sbatch run.slurm
	rm run.slurm	
done
