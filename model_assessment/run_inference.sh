	...
	do
		...
		do
			...
			#	cp template_gpu.slurm run_${hic}_${resolution}_${replicate}_${loss}.slurm
				#echo "python deepsea_inference.py --resolution ${resolution} --model_path concatenation_model/deepsea_bce_${resolution}/${hic}_replicate${replicate}.pkl --seq_label_path ../graph_data/concatenation_input/end_to_end_concatenation_input_seq_label/ --structure_input_path ../graph_data/if_matrix_${resolution}/${hic}_novc_whole_normalized.npy --structure_input_matching_path ../graph_data/concatenation_input/end_to_end_concatenation_input_${resolution}/ --output_path model_prediction_selected/ --output_model_name deepsea_${hic}_fc_${loss}_${resolution}_replicate${replicate} --architecture_name deepsea_concatenation" >> run_${hic}_${resolution}_${replicate}_${loss}.slurm
				#echo "python deepsea_inference.py --resolution ${resolution} --model_path concatenation_model/danq_bce_${resolution}/${hic}_replicate${replicate}.pkl --seq_label_path ../graph_data/concatenation_input/end_to_end_concatenation_input_seq_label/ --structure_input_path ../graph_data/if_matrix_${resolution}/${hic}_novc_whole_normalized.npy --structure_input_matching_path ../graph_data/concatenation_input/end_to_end_concatenation_input_${resolution}/ --output_path model_prediction/ --output_model_name danq_${hic}_fc_${loss}_${resolution}_replicate${replicate} --architecture_name deepsea_concatenation" >> run_${hic}_${resolution}_${replicate}_${loss}.slurm
				#echo "python deepsea_inference.py --resolution ${resolution} --model_path sota_model/deepsea_published.pkl --seq_label_path ../graph_data/concatenation_input/end_to_end_concatenation_input_seq_label/ --structure_input_path ../graph_data/if_matrix_${resolution}/${hic}_novc_whole_normalized.npy --structure_input_matching_path ../graph_data/concatenation_input/end_to_end_concatenation_input_${resolution}/ --output_path model_prediction_selected/ --output_model_name deepsea_sota --architecture_name deepsea" >> run_${hic}_${resolution}_${replicate}_${loss}.slurm
				#echo "python deepsea_inference.py --resolution ${resolution} --model_path sota_model/DanQ_replicated.pkl --seq_label_path ../graph_data/concatenation_input/end_to_end_concatenation_input_seq_label/ --structure_input_path ../graph_data/if_matrix_${resolution}/${hic}_novc_whole_normalized.npy --structure_input_matching_path ../graph_data/concatenation_input/end_to_end_concatenation_input_${resolution}/ --output_path model_prediction_selected/ --output_model_name danq_sota --architecture_name deepsea" >> run_${hic}_${resolution}_${replicate}_${loss}.slurm
